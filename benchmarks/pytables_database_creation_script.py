...
import os
import shutil
os.remove('U:\Observatory\\benchmarks\outputs\\benchmark_pytables.h5')
...
h5file = open_file("U:\Observatory\\benchmarks\outputs\\benchmark_pytables.h5", "a", title="benchmark_pytables")
